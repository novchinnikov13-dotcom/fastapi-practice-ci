...
def init_routes(app):
    ...
    def create_client_handler():
        ...
        new_client = Client(name = name, surname = surname,
    ...
    def create_parking_handler():
        ...
        new_park = Parking(address = address, opened = opened, count_places = count_places,
    ...
    def out_parking_handler():
        ...
        get_parking = db.session.query(CParking).filter_by(client_id = client_id,
